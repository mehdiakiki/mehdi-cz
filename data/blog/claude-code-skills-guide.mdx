...
13. [Before you ship a skill](#13-before-you-ship-a-skill)
...
Anything in the body that looks like `$ARGUMENTS`, `$0`, `$1` gets substituted with what you type at invocation time — covered in [section 7](#7-passing-arguments).
...
The most important field in the file. Claude reads it at session start to decide whether to load the full skill mid-conversation. A weak description means missed invocations or false triggers. How to write it well is covered in [section 8](#8-writing-descriptions-that-work).
