...
- an `/incident-investigation` command that knows how to query logs/metrics *your way*
...
Think of `CLAUDE.md` as *advice*.
Think of CI as *physics*.
...
Claude Code team, AI coding assistant team workflow, CLAUDE.md best practices, Claude Code skills commands, AI developer productivity team, Claude Code onboarding, AI pair programming teams, Claude Code CI integration, multi-agent development workflow, AI code review automation, shared CLAUDE.md, Claude Code coordination, AI team scaling, developer workflow automation, Claude Code commands, AI consistency engineering teams
